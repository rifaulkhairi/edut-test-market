            ...
            <div className="p-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="text-center">
                        <img src={selectedProduct.image} alt="Product" className=" w-2/4 h-auto" style={{ maxHeight: "500px" }} />
                    </div>

                    {/* Bagian Detail Produk */}
                    <div>
                        <h1 className="text-2xl font-bold mb-2">{selectedProduct.title}</h1>
                        <h2 className="text-xl text-indigo-600 mb-4">${selectedProduct.price}</h2>
                        <Rating value={selectedProduct.rating} readOnly precision={0.5} />
                        <p className="mt-4">{selectedProduct.description}</p>
                        <button className="mt-4 bg-indigo-600 text-white px-4 py-2 rounded hover:bg-blue-600">Add to Cart</button>
                    </div>
                </div>
                ...
                <div className=" mt-96">
                    ...
                    <div>
                        ...
                        <div className="mb-4">
                            ...
                            <p className="text-gray-700">User review goes here. It provides feedback about the product.</p>
                        </div>
